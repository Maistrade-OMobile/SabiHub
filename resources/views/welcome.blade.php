...
<body>
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <div class="collapse navbar-collapse main-menu-item justify-content-end"
                            ...
                            <ul class="navbar-nav align-items-center">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#feature_part">Features</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="d-none d-lg-block">
                                   <a class="btn_1" href="#" data-toggle="modal" data-target="#waitingListModal">Join Waiting List</a>
    ...
    <section class="banner_part">
        <div class="container pt-30">
                ...
                <div class="col-12 col-md-8 mx-auto col-lg-6 col-xl-6 banner-img object-fit-contain overflow-hidden">
                    <img src="./img/banner_img.png" class="w-100 h-100" />
                </div>
                <div class="col-12 col-lg-6 col-xl-6">
                    <div class="banner_text">
                        <div class="banner_text_iner">
                            <h5>Empowering Africa’s Future</h5>
                            <h1>A Digital Learning Hub for Students, Teachers, Parents & Creators</h1>
                            <p>SabiHub is a connected EdTech platform that bridges the education gap with tools for managing classrooms, delivering lessons, creating content, and tracking academic growth — all in one app.</p>
                            <a class="btn_2" href="#" data-toggle="modal" data-target="#waitingListModal">Join Waiting List</a>
    ...
    <!-- feature_part start-->
    <section class="feature_part" id="feature_part">
        <div class="container">
            <div class="row gy-4">
                <!-- Core Feature Intro -->
                ...
                <div class="col-sm-6 col-xl-4">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            ...
                            <h4>Schools & Admins</h4>
                            <p>Manage curriculum, schedule classes, assign teachers, and track student performance with powerful LMS tools.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-xl-4">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            <span class="single_feature_icon"><i class="ti-pencil-alt"></i></span>
                            <h4>Teachers</h4>
                            <p>Organize lessons, upload assignments, host classes, and track progress—plus collaborate with fellow educators.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-xl-4">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            ...
                            <h4>Students</h4>
                            <p>Access engaging lessons via video, text, and quizzes. Earn badges, join social learning, and subscribe at NGN 2,000/month.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-xl-4">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            <span class="single_feature_icon"><i class="ti-heart"></i></span>
                            <h4>Parents</h4>
                            <p>Stay connected to your child's education—track progress, message teachers, and manage educational purchases with ease.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-xl-4">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            ...
                            <p>Create courses, monetize educational content, and access dashboards. Join as a SabiHub-approved educator.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="single_member_counter">
                        <span class="counter">{{ $counts['teacher'] ?? 0 }}</span>
                        <h4>All Teachers</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="single_member_counter">
                        <span class="counter">{{ $counts['school'] ?? 0 }}</span>
                        <h4> All Schools</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="single_member_counter">
                        <span class="counter">{{ $counts['parent'] ?? 0 }}</span>
                        <h4>All Parents</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="single_member_counter">
                        <span class="counter">{{ $counts['creator'] ?? 0 }}</span>
                        <h4>All Content Creators</h4>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="partners" class="testimonial_part bg-light py-5">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-5">
                    <div class="section_tittle text-center">
                        ...
                        <br/>
                        <br/>
                        <p class="mb-2 lh-base">We collaborate with leading organizations to deliver impactful, inclusive, and innovative education across Nigeria and beyond.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="textimonial_iner owl-carousel">
                        ...
                        <div class="testimonial_slider">
                            <div class="row justify-content-center align-items-center">
                                <div class="col-md-2 text-center">
                                    <img src="https://omobile.world/static/media/OMOBILE-logo.90c41aae188d3179331be49effa38e13.svg" alt="OMobile" class="img-fluid mb-2 partner-logo">
                                </div>
                                <div class="col-md-6">
                                    <div class="testimonial_slider_text">
                                        <h4>OMobile</h4>
                                        <p>Technology partner helping with infrastructure and nationwide device access.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="testimonial_slider">
                            <div class="row justify-content-center align-items-center">
                                <div class="col-md-2 text-center">
                                    <img src="https://www.gloworld.com/logo.png" alt="Globacom" class="img-fluid mb-2 partner-logo">
                                </div>
                                <div class="col-md-6">
                                    <div class="testimonial_slider_text">
                                        <h4>Globacom</h4>
                                        <p>Telecom partner powering affordable access to learning via mobile data bundles.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="testimonial_slider">
                            <div class="row justify-content-center align-items-center">
                                <div class="col-md-2 text-center">
                                    <img src="img/partners/blaccole.png" alt="Blaccole" class="img-fluid mb-2 partner-logo">
                                </div>
                                <div class="col-md-6">
                                    <div class="testimonial_slider_text">
                                        <h4>Blaccole</h4>
                                        <p>Blaccole embodies innovation, creative ideation, and eco-friendly practices. Our brand champions cutting-edge technology, sustainable solutions, and community-focused initiatives, driving positive change and fostering a better future for West Africa and beyond.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
   ...
   <div class="modal fade" id="waitingListModal" tabindex="-1" role="dialog" aria-labelledby="waitingListModalLabel" aria-hidden="true">
    ...
    <div class="modal fade" id="alreadyInWaitlist" tabindex="-1" aria-labelledby="alreadyInWaitlistLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-body mx-1 mx-md-3 text-center">
                ...
                <p class="h1 mt-3">Oops! You're already in</p>
                <p class="mb-3">Your details are already on the waitlist. Grab a drink and chill!</p>
                <a href="/" class="btn btn_2 mt-3 w-100">Back to home</a>
            </div>
            </div>
        </div>
    </div>
    ...
    <script>
        document.getElementById('userType').addEventListener('change', function () {
            ...
            const schoolExtras = document.getElementById('schoolExtraFields');
            const creatorExtras = document.getElementById('creatorExtraFields');

            // Hide all optional fields by default
            schoolField.classList.add('d-none');
            emailField.classList.add('d-none');
            phoneField.classList.add('d-none');
            schoolExtras.classList.add('d-none');
            creatorExtras.classList.add('d-none');

            if (type === 'creator') {
                // schoolField.classList.remove('d-none');
                emailField.classList.remove('d-none');
                phoneField.classList.remove('d-none');
                creatorExtras.classList.remove('d-none');
            } else if (type === 'teacher' || type === 'parent') {
                schoolField.classList.remove('d-none');
                emailField.classList.remove('d-none');
                phoneField.classList.remove('d-none');
            } else if (type === 'school') {
                schoolExtras.classList.remove('d-none');
                emailField.classList.remove('d-none');
                phoneField.classList.remove('d-none');
            }
        });
            ...
            $('#waitingListModal').on('hidden.bs.modal', function () {
